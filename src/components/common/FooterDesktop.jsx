          ...
          axios.get(AppURL.Allsiteinfo).then(response => {
               ...
               if (StatusCode == 200) {
                    ...
                    this.setState({
                         ...
                         facebook_app_link: JsonData['facebook_app_link'],
                         ...
                         <Container>
                              <Row className="px-0 my-5">
                                   <Col className="p-2" lg={3} md={3} sm={6} xs={12}>
                                        {/* Placeholder Loading section start form here */}
                                        ...
                                        {/* Placeholder Loading section end form here */}
                                        <div className={this.state.mainDiv}>
                                             <h5 className="footer-menu-title">OFFICE ADDRESS</h5>
                                             {parse(this.state.address)}
                                        </div>
                                        <h5 className="footer-menu-title">SOCIAL LINK</h5>
                                        <a href={this.state.facebook_app_link} target="blank"><i className="fab m-1 h4 fa-facebook"></i></a>
                                        <a href={this.state.instagram_link} target="blank"><i className="fab m-1 h4 fa-instagram"></i></a>
                                        <a href={this.state.twitter_link} target="blank"><i className="fab m-1 h4 fa-twitter"></i></a>
                                   </Col>
                                   ...
                                   <Col className="p-2" lg={3} md={3} sm={6} xs={12}>
                                        ...
                                        <a href={this.state.android_app_link} target="blank"><img src={Google} /></a><br></br>
                                        <a href={this.state.android_app_link} target="blank"><img className="mt-2" src={Apple} /></a><br></br>
