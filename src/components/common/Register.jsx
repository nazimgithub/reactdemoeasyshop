                            ...
                            <Row className='text-center'>
                                <Col classname="d-flex justify-content-center" md={6} lg={6} sm={12} xs={12}>
                                    <Form className='onboardForm' onSubmit={this.formSubmit}>
                                        ...
                                        <input className='form-control m-2' type="confirm_password" placeholder='Enter confirm password...' onChange={(e)=>{this.setState({password_confirmation:e.target.value})}}/>
                                        ...
                                        <p><strong>Already Have An account?</strong> <Link to="/login">Sign in</Link></p>
                                    </Form>
                                </Col>
